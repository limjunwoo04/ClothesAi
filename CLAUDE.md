...
## ClothesAi · Project-specific Context

- **User**: 임준우 (한양대 ERICA 인공지능학과). First AI project. Korean-only responses. Direct, honest tone. Explain unknowns (JSON, API, hallucination) with simple analogies.
- **Live site**: https://clothes-ai-seven.vercel.app
